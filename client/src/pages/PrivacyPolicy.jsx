...
import Sec1BG from './../images/pricing_sec_1_bg.jpg';
	...
	return (
		<div id='privacyPolicy'>
			...
			<div className='container'>
				...
				<p>
					This policy (together with our terms of use [See TERMS OF
					USE Section] and any other documents referred to on it) sets
					out the basis on which any personal data we collect from
				...
				<ul>
					...
					<li>
						...
						other communication data, whether this is required for
						our own billing purposes or otherwise] and the resources
						that you access.
					</li>
					<li>
						Details of your response to promotional offer we may
				...
				<p>
					...
					on your browser, which allows you to refuse the setting of
					cookies. However, if you select this setting you may be
					unable to access certain parts of our site. Unless you have
					adjusted your browser setting so that it will refuse
					cookies, our system will issue cookies when you log on to
					our site.
				</p>
				<p>
					Please note that our advertisers may also use cookies, over
					which we have no control.
				</p>
				<p>Where we store your personal data</p>
				<p>
					The data that we collect from you may be transferred to, and
					stored at, a destination outside the Philippines and
					Australia. It may also be processed by staff who work for us
					or for one of our contractors. Such staff maybe engaged in,
					among other things, the fulfillment of your order, the
					processing of your payment details and the provision of
					support services. By submitting your personal data, you
					agree to this transfer, storing or processing. We will take
				...
				<ul>
					...
					<li>
						...
						that you request from which we feel or us may interest
				...
				<p>
					...
					individuals to our clients, but we may provide them with
					aggregate information about our users. We may also use such
					aggregate information to help clients reach the kind of
					personnel they want to target.
				</p>
				<p>
					We will also use the aggregate data to identify employment
					trends across different industries, such as salary averages.
					This information will not be capable of being linked to any
					personally identifying information about users.
				</p>
				<p>
					IMPORTANT: Your current employer may be a user of our site,
					or a client of one of our users. We cannot restrict the
					users who access your information on our database and will
					not be liable for any loss that you suffer as a result of
					users accessing your information. If you are concerned about
					your current employer accessing your information we offer
				...
				<ul>
					...
					<li>
						If Remote Staff or substantially all of its assets are
				...
				<p>
					...
					order to enforce or apply our terms of use [See TERMS OF USE
					Section] or terms and conditions of supply and other
					agreements; or to protect the rights, property, or safety of
					Remote Staff, our customers, or others. This includes
				...
				<p>
					...
					policy are welcomed and should be addressed
					to https://draftsourcevirtual.com
				</p>
			</div>
		</div>
	);
